  ...
  <body>
    ...
    <main>
      ...
      <?php } else { ?>
        ...
        <p>
          Il semblerait que cette page n'existe pas. Si vous pensez qu'il s'agit d'une erreur de notre part, merci de nous le signaler en nous envoyant un courriel en décrivant le problème. Merci d'avance.
        </p>
      <?php } ?>
    </main>
