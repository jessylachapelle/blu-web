	...
	<body>
		...
		<main>			
			...
			<form action="res/sendmail.php" method="post" id="frmContact">
				<label for="nom">Nom<span class="etoile">*</span> :</label><br />
				<input id="nom" name ="nom" type="text" required="" /><br />
				<label for="courriel">Adresse courriel<span class="etoile">*</span> :</label><br />
				<input id="courriel" name="courriel" type="email" required="" /><br />
				<label for="sujet">Sujet<span class="etoile">*</span> :</label><br />
